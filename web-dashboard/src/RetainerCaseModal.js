          ...
          <div className="formbox">
            <div className="flex flex-wrap justify-between">
              ...
              <div className="w-full md:w-1/2 px-3 mb-4 md:mb-0">
                ...
                <input type="text" onChange={e => setValues({ ...values, retainer_status: e.target.value })} className="txtbox shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline mb-4" />
              </div>
            </div>
            <div className="flex flex-wrap justify-between">
