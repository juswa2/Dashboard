    ...
    <div className="flex flex-col md:flex-row h-screen pagescreen">
      <div className="bg-gray-800 w-full md:w-64 navbar md:flex flex-col hidden">
        <div className="flex items-center justify-center h-20 bg-black">
          <img src={logo} className="h-17 w-auto" alt="logo" title="Developer: Joshua Maquimot, Reggie Macariola, Jhelyn Joy Alo, Kriza Maeville Ejurango"/>
        </div>
        <nav className="mt-10">
          ...
          {!isPhone && (
          <footer className="px-1 py-1 text-center mt-[20vw]" style={{ fontSize: '12px', fontWeight: '100' }} title="Developer: Joshua Maquimot, Reggie Macariola, Jhelyn Joy Alo, Kriza Maeville Ejurango">
