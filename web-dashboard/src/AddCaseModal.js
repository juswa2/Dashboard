...
const AddCaseModal = ({ isOpen, onClose, clientId }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50" style={{zIndex: "1"}}>
      <div className="pagedesign bg-white p-8 rounded-lg relative">
        <FontAwesomeIcon
          icon={faTimes}
          ...
          <div className="formbox">
            <div className="flex flex-wrap justify-between">
              <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                <input type="text" onChange={e => setValues({ ...values, case_title: e.target.value })} className="txtbox capitalize shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline mb-4" />
              </div>
              <div className="w-full md:w-1/2 px-3 mb-4 md:mb-0">
                <label className="labelinput block text-white text-sm font-bold mb-2">Status:</label>
                <input type="text" onChange={e => setValues({ ...values, client_status: e.target.value })} className="txtbox shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline mb-4" />
              </div>
            </div>
            <div className="flex flex-wrap justify-between">
              <div className="md:w-1/2 px-3 mb-6 md:mb-0">
                <label className="labelinput block text-white text-sm font-bold mb-2">File:</label>
                <input type="file" onChange={handleFileChange} className="filebox capitalize shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" />
              </div>
              <div className="w-full md:w-1/2 px-3 mb-4 md:mb-0">
