...
function ProfileAdmin() {
  ...
  const handleChange = (e) => {
    ...
    console.log('Updated phone number:', truncatedValue);
  };  
          ...
          {userData && (
            <form className="formedit" onSubmit={handleUpdate}>
              ...
              <div className={isPhone ? "buttonfunction ml-[-25%] flex justify-center" : "buttonfunction flex justify-end"}>
                ...
                <button type="submit" className="px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white font-semibold rounded">Update</button>
              </div>
            </form>
          )}
        </div>
